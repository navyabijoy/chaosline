...
// (docs/09-mcp-spec-notes.md). This fault swaps them, in whichever direction the
// real response actually took:
...
// Nobody tests both directions — see docs/03-fault-taxonomy.md Tier 2b.
