...
// (-32001, in the -32000..-32019 grandfathered range per docs/09-mcp-spec-notes.md —
// -32020..-32099 are reserved for the spec and must not be used for invented codes).
